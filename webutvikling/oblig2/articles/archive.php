  ...
  <body>
    ...
    <main>
      <article class='articleFull'>
        <h2>Arkiv</h2>
        <ul>
          <li><a href='mathml.php'>MathML</a></li>
          <li><a href='svg.php'>SVG</a></li>
          <li><a href='about.php'>Om denne siden</a></li>
        </ul>
        ...
        <ul id='extLinks'>
          ...
          <li><a target='_blank' href='https://css-tricks.com/scale-svg/'>https://css-tricks.com/scale-svg/</a></li>
          <li><a href='https://www.w3schools.com/graphics/svg_grad_linear.asp'>https://www.w3schools.com/graphics/svg_grad_linear.asp</a></li>
        </ul>
      </article>
    </main>
