  ...
  <body>
    ...
    <main>
      <article class='articleFull'>
        ...
        <p>
          Når jeg lagde denne nettsiden prøvde jeg å ikke bruke for mye tid på planlegging, men på å lage nettsiden istedet. Jeg hadde et par ting i bakhodet og så teste jeg ut ulike ting som funket utover det. Det som var fastsatt var at jeg ville ha en hoveddel med artikler sentrert på siden. Ekstra informasjon vil være ved siden, men ikke hovedfokuset på nettsiden
        </p>
        <p>
